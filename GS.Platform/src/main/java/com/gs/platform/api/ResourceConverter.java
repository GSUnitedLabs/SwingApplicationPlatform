 ...
 *  Author     :   Sean Carrick
 *  Created    :   Oct 22, 2021 @ 6:05:59 PM
 ...
 * <p>
 * This class maintains a registry of ResourceConverters. The
 * <code>forType</code> method returns the first ResourceConverter that supports
 * a particular type, new ResourceConverters can be added with
 * <code>register()</code>. A small set of generic ResourceConverters are
 * registered by default. They support the following types:</p>
 * <ul>
 ...
 * </code>. The MessageFormat ResourceConverter just creates MessageFormat
 * object with the string as its constructor argument. The URL/URI converters
 * just apply the corresponding constructor to the resource string.</p>
 *
...
public abstract class ResourceConverter {
    ...
    private static abstract class NumberResourceConverter
        ...
        /**
         * Parses the provided <code>java.lang.String</code> into a valid
         * number. If the string is not able to be parsed to a valid number,
         * then a <code>java.lang.NumberFormatException</code> is thrown.
         *
    ...
    private static abstract class INumberResourceConverter
        ...
        /**
         * Parses a given <code>java.lang.String</code> into a valid number
         * value. In the event that the given string cannot be parsed into a
         * valid number, a <code>java.lang.NumberFormatException</code> is
         * thrown.
         *
         * @param s the <code>java.lang.String</code> to be parsed
