 ...
 *  Author     :   Sean Carrick
 *  Created    :   Oct 23, 2021 @ 2:39:45 PM
...
public class DockingDesktopManager implements DesktopManager {
    ...
    /**
     * Returns the direct child of a `JDesktopPane` that is the parent of the
     * specified component.
     *
     * @param component
     * @return the specified component or one of its parents that is a direct
     * child of a JDesktopPane.
     */
